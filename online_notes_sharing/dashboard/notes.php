            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-xs-4">
            <a href="uploadnote.php" class="btn btn-primary">Add New Code File</a>
            </div>
                         MY Code Files
                        </h1>
...
while ($row = mysqli_fetch_array($run_query)) {
    ...
    echo "<script>alert('Not Code files yet! Start uploading now');
 ...
 <?php
    ...
    if (isset($_GET['del'])) {
        ...
        if (mysqli_affected_rows($conn) > 0) {
            echo "<script>alert('Code file deleted successfully');
