...
<h3 class="page-header">
                            <center> <marquee width = 70% ><font color="green" > Source Code  uploaded by various users</font></marquee></center>
                        </h3>
<div class="row">
<div class="col-lg-12">
...
while ($row = mysqli_fetch_array($run_query)) {
    ...
    echo "<td><a onClick=\"javascript: return confirm('Are you sure you want to approve this source code?')\"href='?approve=$file_id'><i class='fa fa-times' style='color: red;'></i>Approve</a></td>";
 ...
 <?php
    ...
    if (isset($_GET['del'])) {
        ...
        if (mysqli_affected_rows($conn) > 0) {
            echo "<script>alert('Source Code deleted successfully');
        ...
        if (mysqli_affected_rows($conn) > 0) {
            echo "<script>alert('Source Code approved successfully');
            window.location.href='index.php';</script>";
        }
        else {
         echo "<script>alert('error occured.try again!');</script>";   
