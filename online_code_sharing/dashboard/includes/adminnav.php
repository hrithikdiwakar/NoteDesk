 ...
 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./index.php">Online Source Code Management</a>
            </div>
            
            <ul class="nav navbar-right top-nav">
                <?php if($_SESSION['role'] !== 'admin') { ?> <li><a href="./uploadnote.php">Upload Source Code</a></li> <?php } ?>
                <li class="dropdown">
...
<div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <?php if($_SESSION['role'] == 'admin') {
                   ...
                   <li>
                    ...
                    <li>
                         <a href="javascript:;" data-toggle="collapse" data-target="#user"><i class="fa fa-fw fa-users"></i> My Code Files <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="user" class="collapse">
                            <li>
                                <a href="./notes.php">View All Code Files</a>
                            </li>
                            <li>
                                <a href="./uploadnote.php">Upload Code File</a>
                            </li>
